...
<template>
  <div class="header container-fluid d-none d-xl-block mb-5 position-fixed top-0 start-0 z-3" :style="{backgroundColor: color.theme_color, color: color.tab_color}">
